...
public class P_Etudiants extends P_Principal implements ActionListener {
	...
	public P_Etudiants () {
		...
		this.PanelForm.add(new JLabel("Diplome Prepar� : "));
		...
		String entetes [] = {"ID Etudiant", "Nom", "Pr�nom", "Adresse","Telephone", "Email","mdp", "ID Classe"};
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(e.getSource() == this.btAnnuler) {
			...
			JOptionPane.showMessageDialog(this, "L'Etudiant a bien �t� ajout�.");
			this.viderChamps();
